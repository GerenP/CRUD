...
<div class="container mt-4">
    ...
    <div class="card">
        <div class="card-body">
            <form action="insertkunjungan.php" method="POST">
                <div class="mb-3">
                    <label for="idPasien" class="form-label">ID Pasien:</label>
                    <input type="number" class="form-control" id="idPasien" name="idPasien" required>
                </div>
                <div class="mb-3">
                    <label for="idDokter" class="form-label">ID Dokter:</label>
                    <input type="number" class="form-control" id="idDokter" name="idDokter" required>
                </div>
                <div class="mb-3">
